...
<div class="wrapper"><br clear="all" /><br clear="all" />

<img src="http://moneymappress.com/wp-content/themes/money-map-press/images/logo.png" width="238" style="float:left;" /><br clear="all" /><br clear="all" />
  ...
  <?php
   ...
   // The onsubmit attribute of the form is used to call two scripts that validate the form
	if(isset($_POST['g-recaptcha-response'])){
        ...
        $secretKey = "6LcDGkYUAAAAABXWyXaaEA5bZc6fv5PnDvL-xtPJ";
...
window.onload = function() {
  var recaptcha = document.forms["csform"]["g-recaptcha-response"];
  ...
  <form action="/cs/cs-form-submit2.php" method="post" name="csform" id="csform" onsubmit="return checkForm(this) && validate();">
    <table align="center" border="0" cellpadding="5" style="margin: 0px auto; text-align: right; float: none;" width="600">
      <tbody>
        <tr>
          <td width="150"><label for="full_name">Full Name:</label></td>
          <td style="text-align: left;"><input maxlength="50" name="full_name" placeholder="Full Name" size="30" type="text" pattern="^[A-z .]{2,}$" required /><span style="color:red;"> *</span></td>
        </tr>
        <tr>
          <td><label for="email">Email Address:</label></td>
          <td style="text-align: left;"><input id="email" placeholder="Email Address" maxlength="80" name="email" size="30" type="email" value="<?php echo $emailaddress; ?>" required /><span style="color:red;"> *</span></td>
        </tr>
        <tr>
     ...
     <select id="reasons" name="reason_primary" style="background-color: #F8F8F8; height: 30px; padding:3px; width: 200px;" required>
        ...
        <tr><td>Comments:</td>
        <td style="text-align:left; float:left;"><textarea class="contact-comments" placeholder="Provide additional details to expedite your request" name="comments" rows="5" cols="40" /></textarea></td></tr>
        <tr><td></td>
			<td><div class="g-recaptcha" name="recaptcha" data-sitekey="6LcDGkYUAAAAAGUAuatcM-0oq-6aZ_jdV77RPG2j" data-callback="enableBtn"></div></td>
		</tr>
           <tr>
          <td align="center" colspan="2" id="submitButton" style="margin-top: 10px;"><center>
              <input type="submit" value="SUBMIT" id="submitBtn" style="height: 30px; padding: 7px; width: 100px; background-color: grey; color: white;"/>
              <br />
...
$("#pubselect").change(function () {  
   ...
   $("#pubselect option:selected").each(function() {   
       currSelect = $(this).text();
		   ...
		   // if MMR is selected, show the cancel option
		   // if(currSelect == "Money Map Report") {
			   // $("#reasons option[value='Cancel Subscription']").show();	
		   // } else {
			   // $("#reasons option[value='Cancel Subscription']").hide();	
		   // }
});
...
<hr style="height:1px; color:#CCCCCC;" /><br clear="all" /><br clear="all" />
<strong>Money Map Press</strong><br /><br clear="all" />

16 W. Madison St. Baltimore, MD 21201 USA&nbsp;&nbsp;|&nbsp;&nbsp;
Toll-free: 1.888.384.8339 | International: 1.443.353.4519&nbsp;&nbsp;|&nbsp;&nbsp;
Fax 1.410.622.3050<br /><br /><br clear="all" />
</div>
</div></div>
</body>
</html>